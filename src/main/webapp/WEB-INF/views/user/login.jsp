...
<c:if test="${result eq 'userPw'}">
	<script>alert('메일로 비밀번호를 전송하였습니다. 다시 로그인해주세요.');</script>
</c:if>
<c:if test="${result eq 'userId'}">
	<script>alert('메일로 아이디를 전송하였습니다. 다시 로그인해주세요.');</script>
</c:if>
				...
				<form name="loginform" action="/user/login" method="post"
					...
					<table style="margin: 0 0 2rem 0 !important;">
						<tr>
							<td>아이디</td>
							<td>
								<input class="put" type="text" name="userId"
								placeholder="아이디를 입력하세요" OnKeyDown="focusEnter(this.form,this)">
							</td>
						</tr>
						<tr>
							<td>비밀번호</td>
							<td>
								<input class="put" type="password" name="userPw"
								placeholder="비밀번호를 입력하세요" onkeydown="JavaScript:loginEnter();">
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<input style="width: 156px;"
								class="btn primary" type="button" value="로그인" onclick="sendit()">
							</td>
						</tr>
					</table>
					<div style="text-align: center; width: 100%;">
						<div style="display: inline-block;">
							<ul
								style="list-style: none; display: inline-block; padding-left: 0;">
								<li style="float: left; margin-right: 20px;">
									<input style="width: 156px; text-align: center;" class="btn"
									type="button" value="비밀번호 찾기" onclick="location.href='/user/findPw'">
								</li>
								<li style="float: left; margin-right: 20px;">
									<input style="width: 156px;" class="btn" type="button" value="아이디 찾기"
									onclick="location.href='/user/findId'">
								</li>
								<li style="float: left;">
									<input style="width: 156px;" class="btn" type="button" value="회원가입"
