...
<c:if test="${result == false}">
	<script>alert('이름 혹은 이메일을 다시 확인해주세요.');</script>
</c:if>
<body class="is-preload">
	...
	<header id="header" class="alt">
		...
		<h1 style="letter-spacing: -4px; font-size: 40px;">아이디 찾기</h1>
	</header>
					...
					<div id="container">
						<table style="margin: 0 0 2rem 0 !important;">
							<tr>
								<td>이름</td>
								<td>
									<input class="put" type="text" name="userName" id="userName" 
									placeholder="아이디를 찾고자 하는 이름을 입력하세요" OnKeyDown="focusEnter(this.form,this)">
								</td>
							</tr>
							<tr>
								<td>이메일</td>
								<td>
									...
									placeholder="가입시 입력하셨던 이메일을 입력하세요" OnKeyDown="findIdEnter();">
								</td>
							</tr>
							<tr>
								<td colspan="2">
								<input style="width: 156px;" class="btn primary" type="button"
								value="아이디 찾기" onclick="findId()">
								</td>
							</tr>
						</table>
