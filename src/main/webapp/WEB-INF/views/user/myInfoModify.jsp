	...
	<header id="header" class="alt">
		...
		<nav id="nav" style="margin: 0 auto 2.3rem auto;">
			<ul>
				...
				<li class="current">
					<a href="#" class="dropdown">My Menu</a>
					<ul>
		...
		<h1 style="letter-spacing: -4px; font-size: 40px;">내 정보 수정</h1>
	</header>
						...
						<table>
							...
							<tr>
								<td colspan="3" style="text-align: center; padding: 1.5rem 0;"
									class="put"><input type="button" value="SIGN UP" onclick="sendit()">
								</td>
							</tr>
						</table>
					</div>
