...
<body class="is-preload">
	...
	<div id="main">
		<div class="wrapper">
			<div class="inner">
				...
				<form action="/follow/follower" id="searchForm" method="get">
				...
				<form name="requestform" id="acceptForm" method="post">
					<table class="alt">
						<thead>
							<tr>
								<th style="width: 33%; text-align: center;">나를 팔로우하는 유저 아이디</th>
								<th style="width: 33%; text-align: center;">나를 팔로우한 날짜</th>
	...
	<form id="followerForm" name="followerForm" action="/follow/follower" method="get">
