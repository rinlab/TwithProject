...
<body class="is-preload">
	...
	<div id="main">
		<div class="wrapper">
			<div class="inner">
				<hr>
				<form name="makeform" action="/moim/make" method="post">
					<div id="container">
						...
						<table>
							...
							<tr>
								<td>모임 이름</td>
								<td colspan="2"><input type="text" name="moimname"></td>
							</tr>
							<tr>
								<td>여행 분류</td>
								...
								<td style="width: 80%;">
									<div class="map_wrap">
										...
										<div id="menu_wrap" class="bg_white">
											<div class="option">
												<div>
													<input type="text" value="코리아 IT 아카데미" id="keyword" size="15">
									...
									<div>
										<input type="text" id="placename" name="placename" readonly>
							...
							<tr>
								<td>경비</td>
								<td colspan="2">
									<input type="text" name="moimbudget"></td>
							</tr>
							<tr>
								<td>출발날짜</td>
								<td colspan="2">
									<input type="text" id="datepicker1" name="startdate"></td>
							</tr>
							<tr>
								<td>끝날짜</td>
								<td colspan="2">
									<input type="text" id="datepicker2" name="enddate"></td>
							</tr>
							<tr>
								<td>모임장</td>
								<td colspan="2">
									<input type="text" name="userid" readonly value="${sessionScope.user.userId}"></td>
							</tr>
							<tr>
								<td colspan="3" class="put">
									<input type="submit" value="모임 등록"></td>
							</tr>
						</table>
					</div>
				</form>
